...
- Problèmes spécifiques liés au langage ou au framework utilisé, tels que le papier Scarlet pour PHP ou [listes de contrôle Microsoft Secure Coding pour ASP.NET] (https://msdn.microsoft.com/en-us/library/ff648269.aspx ); et
